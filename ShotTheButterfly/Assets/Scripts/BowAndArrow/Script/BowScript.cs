...
namespace DigitalRuby.BowAndArrow
{
    ...
    public class BowScript : MonoBehaviour
    {
        ...
        public void RenderBowString(Vector3 arrowPos)
        {
        ...
        private void Update()
        {
            ...
            // GetMouseButtonDown: Only return TRUE in the frame the left mouse button is clicked
            ...
            // GetMouseButton: Return TRUE for every frame the left mouse button is clicked and held
        ...
        public void RotateRight()
        {
            ...
            angle -= 90;
            Debug.Log("RotateRight: Angle = " + angle);
        ...
        public void RotateLeft()
        {
            ...
            angle = Mathf.Atan2(-lookPos.y, -lookPos.x) * Mathf.Rad2Deg;
            angle -= 90;
            Debug.Log("RotateLeft: Angle = " + angle);
            transform.rotation = Quaternion.Euler(0, 0, angle);
            //transform.rotation = Quaternion.AngleAxis(angle, Vector3.back); 
            //transform.rotation = Quaternion.AngleAxis(angle, Vector3.forward);
            RenderBowString(Vector3.zero);
