...
BOOL CFileVersionInfo::Create(LPCTSTR lpszFileName)
{
	...
	try
	{
		...
		m_strProductVersion.Format(L"%d.%d.%d.%d",GetProductVersion(3),GetProductVersion(2),GetProductVersion(1),GetProductVersion(0));
...
// bool CFileVersionInfo::isNewer(CString strVersion)
// {
// 	CStringArray  List;
// 	List.RemoveAll();
// 	SplitString(strVersion,".",List);
// 	if (List.GetSize()<4) 
// 	{
// 		return false;
// 	}
...
// 
// 
// 	int t = GetProductVersion(3);
// 
// 	if (GetProductVersion(3) < i0) 
// 		return true;
// 	else
// 	if (GetProductVersion(3) > i0) 
// 		return false;
